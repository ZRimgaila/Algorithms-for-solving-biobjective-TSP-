...
def main():
    ...
    iterations = []
    metrika = []
    branchAndBound_result = ['Vilnius', 'Kaunas', 'Alytus', 'Marijampolė', 'Jonava', 'Kėdainiai', 'Tauragė', 'Šilutė', 'Klaipėda', 'Kretinga',
    'Palanga', 'Plungė', 'Mažeikiai', 'Telšiai', 'Šiauliai', 'Radviliškis', 'Panevėžys', 'Ukmergė', 'Utena', 'Visaginas', 'Vilnius']
    ...
    while generations > 0:
        ...
        if(generations == 1 or (fuel == 129.084 and dur == 1087)):
